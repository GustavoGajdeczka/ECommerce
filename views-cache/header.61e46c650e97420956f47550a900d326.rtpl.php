...
<head>
  ...
  <title>AdminLTE 2 | Gajdeczka-Store</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">A. Gustavo Gajdeczka</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  A. Gustavo Gajdeczka - Web Developer
                  <small>Member since ago. 2020</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
